...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_datasets_dataset_id"), "datasets", ["dataset_id"], unique=False
    )
    ...
    op.create_index(
        op.f("ix_federated_sessions_id"), "federated_sessions", ["id"], unique=False
    )
    op.create_table(
        "notifications",
        sa.Column("id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_benchmarks_benchmark_id"), "benchmarks", ["benchmark_id"], unique=False
    )
    op.create_index(
        op.f("ix_benchmarks_created_at"), "benchmarks", ["created_at"], unique=False
    )
    op.create_index(
        op.f("ix_benchmarks_task_id"), "benchmarks", ["task_id"], unique=False
    )
    op.create_table(
    ...
    op.create_index(
        op.f("ix_federated_round_client_submissions_id"),
        "federated_round_client_submissions",
        ["id"],
        unique=False,
    )
    op.create_table(
        "federated_session_clients",
        sa.Column("id", sa.Integer(), nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("session_id", sa.Integer(), nullable=False),
    ...
    op.create_index(
        op.f("ix_federated_session_clients_id"),
        "federated_session_clients",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column("deletedAt", sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(
            ["session_id"], ["federated_sessions.id"], ondelete="CASCADE"
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_federated_session_logs_id"),
        "federated_session_logs",
        ["id"],
        unique=False,
    )
    ...
    op.create_index(
        op.f("ix_federated_test_results_id"),
        "federated_test_results",
        ["id"],
        unique=False,
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["federated_session_id"],
            ["federated_sessions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
    )
    op.create_index(
        op.f("ix_training_data_transfers_federated_session_id"),
        "training_data_transfers",
        ["federated_session_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_training_data_transfers_id"),
        "training_data_transfers",
        ["id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["submission_id"],
            ["federated_round_client_submissions.id"],
        ),
        sa.PrimaryKeyConstraint("id"),
...
def downgrade() -> None:
    ...
    op.drop_index(
        op.f("ix_training_data_transfers_id"), table_name="training_data_transfers"
    )
    op.drop_index(
        op.f("ix_training_data_transfers_federated_session_id"),
        table_name="training_data_transfers",
    )
    op.drop_table("training_data_transfers")
    op.drop_table("global_model_weights")
    op.drop_index(
        op.f("ix_federated_test_results_id"), table_name="federated_test_results"
    )
    op.drop_table("federated_test_results")
    op.drop_index(
        op.f("ix_federated_session_logs_id"), table_name="federated_session_logs"
    )
    op.drop_table("federated_session_logs")
    op.drop_index(
        op.f("ix_federated_session_clients_id"), table_name="federated_session_clients"
    )
    op.drop_table("federated_session_clients")
    op.drop_index(
        op.f("ix_federated_round_client_submissions_id"),
        table_name="federated_round_client_submissions",
    )
